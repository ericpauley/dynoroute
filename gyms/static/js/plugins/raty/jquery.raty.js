...
;(function($) {
  ...
  $.fn.raty.defaults = {
    ...
    size          : 16,
    space         : true,
    starHalf      : static_url+'js/plugins/raty/images/star-half.png',
    starOff       : static_url+'js/plugins/raty/images/star-off-big.png',
    starOn        : static_url+'js/plugins/raty/images/star-on-big.png',
    target        : undefined,
    targetFormat  : '{score}',
    targetKeep    : false,
    targetText    : '',
